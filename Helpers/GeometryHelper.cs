...
public static class GeometryHelper
{
    ...
    /// <returns></returns>
    public static List<Point> TessellateArc(Segment arcSegment)
    {
        ...
        int numSteps = (int)Math.Ceiling(Math.Abs(sweepAngle * 180.0 / Math.PI) / 10.0);
        if (numSteps == 0)
        {
            points.Add(start);
            points.Add(end);
        ...
        double angleStep = sweepAngle / numSteps;
